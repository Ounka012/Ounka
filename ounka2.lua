...
local ESP_SETTINGS = {
    ...
    ShowTeam = true,
    ShowTeamName = true,
    TeamCheck = true,      -- លាក់ team ខ្លួនឯង
    ShowTeammates = false, -- បង្ហាញ team ខ្លួនឯងឬអត់
    MaxDistance = 2000,
    TextSize = 13,
    ...
    -- ពណ៌ក្រុម
    TeamColors = {
        ["Survivor"] = Color3.fromRGB(0, 200, 255),    -- ខៀវ
        ["Monster"] = Color3.fromRGB(255, 50, 50),      -- ក្រហម
        ["Default"] = Color3.fromRGB(255, 220, 100),   -- លឿង
        ["Neutral"] = Color3.fromRGB(150, 255, 100),     -- បៃតង
    }
}
