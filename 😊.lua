-- ==================================================
-- MKRA HUB - MODERN UI
-- UI ONLY + TABS + MOBILE + NOTIFICATIONS
-- ==================================================
...
-- បន្ទាប់ពី upload រូបទៅ Roblox:
-- local IMAGE_ASSET = "rbxassetid://YOUR_IMAGE_ASSET_ID"
...
local function createUI(imageAsset)
    ...
    body.Size =
        UDim2.new(1, -24, 1, -120)

    body.Position =
        UDim2.fromOffset(12, 112)
